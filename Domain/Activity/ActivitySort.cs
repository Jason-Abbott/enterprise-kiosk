...
namespace AMP {
	public class ActivitySort : IComparer<Activity> {
		...
		public ActivitySort(Fields field) { _field = field; }
		public ActivitySort(Fields sort, Entity.SortDirections direction) {
			_field = sort;
